...
export function ExceptionDisplay({ content }: ExceptionDisplayProps) {
  ...
  return (
    <div className={`rounded-lg border ${borderClass}`}>
      <div
        className="px-4 py-3 overflow-x-auto flex items-start justify-between gap-4 overflow-y-hidden"
